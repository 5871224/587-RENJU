...
<main class="main">
    ...
    <?php else: ?>
        <div class="notice">
            <strong>現有 RANK 只作歷史參考，不是重算來源。</strong> 因為歷史對局可能已刪除，或曾把新比賽插入既有賽號序列，所以「重算後變更」與「新增比賽（舊 RANK 無資料）」都是預期結果。新人基本分：1級 2150、2級 2000、3級 1850、4級 1700、5級 1550、6級 1400；PLAYER.顯示=1 延續前次重算績分；國家非台灣且顯示=0 的外部棋士使用比賽開始日前的 RenjuNet Elo，若 RenjuNet 已對應但尚無歷史資料則以 1900 作為新人初始分；賽號 233 因 RenjuNet 無該賽事資料，未對應的外國新人也固定以 1900 起算。
        </div>
