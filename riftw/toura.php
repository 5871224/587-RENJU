...
ORDER BY `開始` DESC, `結束` DESC");
    ...
    foreach ($statement as $row) {
        ...
        $isInternational = strpos($row['賽標'], "世界") !== false || strpos($row['賽標'], "亞洲") !== false;
        $linkClass = $isInternational ? " class='international-link'" : "";
        $URL = "<a" . $linkClass . " href='tourb.php?TOUR=" . $row['賽號'] . "'>" . $row['賽標'] . "</a>";
